...
function getBillboards(){
	$.get("../server/user-billboards.php", function(data, status){
		...
		for (var i = 0; i < billboards.length; i++) {
			...
			"</td>" +
			"<td class=\"text-center\" style=\"vertical-align: middle;width: 33.33%;\"><span id=\"" + billboards[i].id + "\"  class=\"glyphicon glyphicon-pencil actions information\" data-toggle=\"modal\" data-target=\"#EditModal\"><br></span><br><p style=\"font-size: 14px;\"><b><i>Edit</b></i></p></span>" +
			"<span id=\"" + billboards[i].id + "\" class=\"glyphicon glyphicon-trash actions deleteBillboard\"><br></span><br><p style=\"font-size: 14px;\"><b><i>Information</b></i></p></span>" +
			"</td>" +
			"</tr>";
		}
		$("#billboards").empty();
